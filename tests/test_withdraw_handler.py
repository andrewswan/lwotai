...
class WithdrawHandlerTest(LabyrinthTestCase):
    ...
    def test_withdraw(self):
        ...
        self.assertEqual(app.get_country("Afghanistan").aid, 1)
        self.assertEqual(app.get_country("Afghanistan").besieged, 0)
        ...
        self.assertEqual(app.get_country("Afghanistan").aid, 0)
        self.assertEqual(app.get_country("Afghanistan").besieged, 1)
